...
require 'connection.php';
  ...
  if(isset($_POST['save1'])){
    ...
    $Designation = $_POST['first_name'];

    $sqli = "UPDATE admin SET Admin_Name ='$ID', Email = '$Full_name',Mobile_Number= '$Designation' WHERE Admin_ID ='$i'";
  echo"$sqli";
  ...
  if(isset($_POST['save2'])){
    $i='1';
    $ID=$_POST['address'];
    $Full_name = $_POST['city'];
    $Designation = $_POST['country'];

    $sqli = "UPDATE admin SET Address ='$ID', City = '$Full_name',Country= '$Designation' WHERE Admin_ID ='$i'";
  echo"$sqli";
  $update = mysqli_query($conn,$sqli );
  if($update){
    echo "<script>
        ...
        <div class="d-flex flex-column" id="content-wrapper">
            ...
            <div class="container-fluid">
                ...
                <div class="row mb-3">
                    <div class="col-lg-4">
                        <div class="card mb-3">
                            <div class="card-body text-center shadow"><img class="rounded-circle mb-3 mt-4" src="assets/img/avatars/avatar1.png" width="160" height="160">
                            ...
                            <div class="col">
                                <div class="card shadow mb-3">
                                    <div class="card-header py-3">
                                        <p class="text-primary m-0 font-weight-bold">Update Admin Settings</p>
                                    </div>
                                    <div class="card-body">
                                        <form action="profileA.php" method="post">
                                            <div class="form-row">
                                                <div class="col">
                                                    <div class="form-group"><label for="username"><strong>Name</strong></label><input class="form-control" type="text" value="<?=$row['Admin_Name'];?>" name="username"></div>
                                                </div>
                                                <div class="col">
                                                    <div class="form-group"><label for="email"><strong>Email Address</strong></label><input class="form-control" type="email" value="<?=$row['Email'];?>" name="email"></div>
                                                </div>
                                            </div>
                                            <div class="form-row">
                                                <div class="col">
                                                    <div class="form-group"><label for="first_name"><strong>Mobile number</strong></label><input class="form-control" type="text" value="<?=$row['Mobile_Number'];?>" name="first_name"></div>
                                                </div>

                                            </div >
                                            <div class="form-group"><button class="btn btn-primary btn-sm" type="submit" name="save1">Save Settings</button></div>
                                        </form>
                                    </div>
                                </div>
                                <div class="card shadow">
                                    <div class="card-header py-3">
                                        <p class="text-primary m-0 font-weight-bold">Update Contact Settings</p>
                                    </div>
                                    <div class="card-body">
                                        <form action="profileA.php" method="post">
                                            <div class="form-group"><label for="address"><strong>Address</strong></label><input class="form-control" type="text" value="<?=$row['Address'];?>" name="address"></div>
                                            <div class="form-row">
                                                <div class="col">
                                                    <div class="form-group"><label for="city"><strong>City</strong></label><input class="form-control" type="text" value="<?=$row['City'];?>" name="city"></div>
                                                </div>
                                                <div class="col">
                                                    <div class="form-group"><label for="country"><strong>Country</strong></label><input class="form-control" type="text" value="<?=$row['Country'];?>" name="country"></div>
                                                </div>
                                            </div>
                                            <div class="form-group"><button class="btn btn-primary btn-sm" type="submit" name="save2">Save&nbsp;Settings</button></div>
                                        </form>
                                    </div>
                                </div>
                            </div>
