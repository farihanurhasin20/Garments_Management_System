...
$data=$_SESSION["name"];
  ...
  $sqli="SELECT * FROM clients WHERE Email='$data'";
  ...
  if(isset($_POST['save1'])){
    ...
    $sqli = "UPDATE clients SET Client_Name ='$ID', Email = '$Full_name',Phone= '$Designation' WHERE Email ='$data'";
  ...
  if(isset($_POST['save2'])){
    ...
    $sqli = "UPDATE clients SET Address ='$ID', Country= '$Designation' WHERE Email ='$data'";
  echo"$sqli";
  $update = mysqli_query($conn,$sqli );
  if($update){
    echo "<script>
                                ...
                                <div class="card shadow mb-3">
                                    ...
                                    <div class="card-body">
                                        <form action="profileA.php" method="post">
                                            <div class="form-row">
                                                <div class="col">
                                                    <div class="form-group"><label for="username"><strong>Name</strong></label><input class="form-control" type="text" value="<?=$row['Client_Name'];?>" name="username"></div>
                                                </div>
                                                <div class="col">
                                            ...
                                            <div class="form-row">
                                                <div class="col">
                                                    <div class="form-group"><label for="first_name"><strong>Mobile number</strong></label><input class="form-control" type="text" value="<?=$row['Phone'];?>" name="first_name"></div>
                                                </div>
